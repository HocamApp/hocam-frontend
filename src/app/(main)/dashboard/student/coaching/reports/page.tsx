...
function StudentReportsContent() {
  ...
  return <div className="space-y-3"><CoachingSectionHeading>Yayınlanan raporlar</CoachingSectionHeading>{reports.filter((report) => report.latest_revision).map((report) => {
