...
export default function TutorCoachingComplaintsPage() { return <CoachingRecordGuard><CoachingPageShell title="Koçluk başvuruları" width="wide" currentHref="/dashboard/tutor/coaching/complaints" audience="tutor"><Complaints /></CoachingPageShell></CoachingRecordGuard>; }
