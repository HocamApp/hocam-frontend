...
import { COACHING_FAZ8_QUERY_KEYS, coachingDisputeCategoryLabel, coachingDisputeStatusLabel, fetchTutorCoachingDisputes } from "@/lib/coachingApi";
...
export default function TutorCoachingComplaintsPage() { return <CoachingRecordGuard><CoachingPageShell title="Koçluk sorun bildirimleri" width="wide" currentHref="/dashboard/tutor/coaching/complaints" audience="tutor"><Complaints /></CoachingPageShell></CoachingRecordGuard>; }
