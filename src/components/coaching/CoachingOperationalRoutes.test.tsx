...
describe("Coaching operational route shells", () => {
  ...
  it("keeps the shared coaching surface inside the DESIGN.md vocabulary", () => {
    const sharedFiles = [
      ...
      "src/components/coaching/OnboardingControlQuestions.tsx",
      "src/app/(main)/dashboard/tutor/coaching/onboarding/page.tsx",
      "src/app/(main)/dashboard/tutor/coaching/plan/page.tsx",
    ];
    const banned = [
      /lucide-react/,
      /Sparkles/,
