...
import { AIChatResponse, AIIntent, sendAIChatMessage } from "@/lib/aiAssistantApi";
...
export function AISupportChatWidget() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: "assistant",
      content:
        "Merhaba, ben Hocam AI Asistan. Destek, rezervasyon ve mentor konularında hızlıca yardımcı olabilirim.",
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end gap-3 sm:bottom-6 sm:right-6">
      {isOpen && (
        <section className="flex h-[min(680px,calc(100vh-112px))] w-[calc(100vw-32px)] flex-col overflow-hidden rounded-lg border border-border bg-card shadow-2xl motion-safe:animate-message-pop sm:w-[380px]">
