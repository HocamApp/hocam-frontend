  ...
  return (
    <div className={cn("group relative inline-flex shrink-0", className)}>
      ...
      {/* Hidden below sm rather than merely transparent. The heart sits at the
          ...
          hover. */}
      <span className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-3 hidden -translate-x-1/2 translate-y-1 sm:block whitespace-nowrap rounded-pill bg-ink px-2.5 py-1 text-label text-paper opacity-0 shadow-float transition duration-200 ease-out scale-95 group-hover:translate-y-0 group-hover:scale-100 group-hover:opacity-100 peer-focus-visible:translate-y-0 peer-focus-visible:scale-100 peer-focus-visible:opacity-100">
        {tooltipLabel}
