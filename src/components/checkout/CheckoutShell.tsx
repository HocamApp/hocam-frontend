...
export function CheckoutShell({
  ...
  header: ReactNode;
  /** The left column. Null since the product card moved to the schedule step,
   * which leaves the decision column alone and full width. */
  ...
  return (
    ...
    >
      ...
      <main
        ...
        className={
          exploration
            ? "grid min-h-[calc(100dvh-var(--app-header-row-1-h))] lg:grid-cols-[minmax(0,3fr)_minmax(26rem,2fr)]"
            : "grid min-h-[calc(100dvh-var(--app-header-row-1-h))]"
        }
      >
        {exploration && (
          <section
        ...
        {decision && (
          <aside
            ...
            className={`min-w-0 bg-[var(--checkout-right-surface)] px-4 pb-32 pt-5 text-[var(--checkout-right-ink)] sm:px-7 sm:pt-6 lg:pb-8 lg:pt-6 ${
              exploration
                ? "border-t border-[var(--checkout-soft-line)] lg:border-l lg:border-t-0 lg:px-7 xl:px-9"
                : "lg:px-7"
            }`}
          >
            <div
