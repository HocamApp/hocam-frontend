...
export function MessageBubble({
  ...
  return (
    <div
      ...
      className={cn(
        "group flex w-full scroll-mt-20 items-center gap-1",
    ...
    >
      ...
      <div
        className={cn(
          "max-w-[75%] rounded-2xl px-4 py-2 shadow-sm sm:max-w-[70%]",
          isOwnMessage
          ...
          <>
            {reply && (
              <button
                ...
                className={cn(
                  "mb-1.5 flex w-full items-center gap-1.5 rounded-md border-l-2 px-2 py-1 text-left text-xs",
                  isOwnMessage
