<!-- User-provided roadmap, archived 2026-09-17. Attachment SHA-256: 646948de9ae64547abf1a5477e6763212af9b139a00df795d305a0a2c600b0b1. Trailing line whitespace is normalized. Only the roadmap section is retained; the following conversational request is excluded. Historical source: see PAYTR_FRONTEND_PLAN.md and PAYTR_CONTRACT.md for verified decisions and current contract. -->
...
**Backend dependency:** `hocam-backend` PR [#163]([https://github.com/HocamApp/hocam-backend/pull/163](https://github.com/HocamApp/hocam-backend/pull/163))
...
- Accept only an iframe URL beginning with `[https://www.paytr.com/odeme/guvenli/](https://www.paytr.com/odeme/guvenli/)`.
